...
final class OpenCepIntegrationTest extends TestCase
{
    public function testShouldSearchCepUsingOpenCep(): void
    {
...
// $ ./vendor/bin/phpunit tests/Integration/OpenCepIntegrationTest.php
